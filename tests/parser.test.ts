...
describe("Assignment", () => {
    ...
    test("Mixed", "a = 1 + 1", [
        new AssignmentExpr(new Identifier("a"), new BinaryExpr(new NumberLiteral("1"), new NumberLiteral("1"), "+")),
    ])

    test("Mixed Chain", "a = b = 1 + 1", [
        new AssignmentExpr(
            new Identifier("a"),
            new AssignmentExpr(new Identifier("b"), new BinaryExpr(new NumberLiteral("1"), new NumberLiteral("1"), "+"))
        ),
    ])
})
...
describe("Dictionary", () => {
    ...
    test("Key Shorthand", "{c}", [new DictionaryLiteral([new Propety(new StringLiteral("c"), new Identifier("c"))])])
    ...
    test("Mixed All", '{a:1, 2, c:3+4, d:=5, "hello":6}', [
        new DictionaryLiteral([
            new Propety(new StringLiteral("a"), new NumberLiteral("1")),
            new Propety(new NumberLiteral("2"), new NumberLiteral("2")),
            new Propety(new StringLiteral("c"), new BinaryExpr(new NumberLiteral("3"), new NumberLiteral("4"), "+")),
...
describe("Control Flow", () => {
    test("Basic", "if (a) {a = 10}", [
        new IfStmt(new Identifier("a"), new Block([new AssignmentExpr(new Identifier("a"), new NumberLiteral("10"))])),
    ])
